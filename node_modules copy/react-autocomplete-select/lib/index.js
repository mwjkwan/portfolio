...
var _OptionsParent = require('./OptionsParent');

var _OptionsParent2 = _interopRequireDefault(_OptionsParent);
...
exports.default = Object.assign(function (_Component) {
	...
	function _class2() {
		...
		return _ret = (_temp = (_this = _possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.state = {
		...
		}, _this.currentFocus = -1, _this.inputRef = _react2.default.createRef(), _this.optionRefs = [], _this.setRef = function (ref) {
			...
			if (axiosConfig instanceof Object) {
				(0, _axios2.default)(axiosConfig).then(function (res) {
    ...
    decrease the currentFocus variable:*/
			...
			return _react2.default.createElement('input', obj);
		...
		return _react2.default.createElement(
			...
			_react2.default.createElement(
				...
				_react2.default.createElement(
					...
					this.inputJSX(),
					_react2.default.createElement(
						_OptionsParent2.default,
						null,
						this.state.searchData.map(function (val, key) {

							return key <= _this2.state.maxOptionsLimit ? _react2.default.createElement(_Options2.default, { ref: _this2.setRef, JSX: _this2.state.optionsJSX || function (value) {
									return value;
			...
			_react2.default.createElement(GlobalStyle, { globalStyle: this.props.globalStyle })
		);
	};

	return _class2;
}(_react.Component), { propTypes: {
		searchPattern: _propTypes2.default.oneOf(['startsWith', 'endsWith', 'containsString', 'containsLetter']),
		getItemValue: _propTypes2.default.func.isRequired,
		itemsData: _propTypes2.default.array.isRequired,
		inputJSX: _propTypes2.default.func,
		optionsJSX: _propTypes2.default.func,
		maxOptionsLimit: _propTypes2.default.number,
		searchEnabled: _propTypes2.default.bool,
		selectOnBlur: _propTypes2.default.bool,
		inputRef: _propTypes2.default.object,
		onChange: _propTypes2.default.func,
		onSelect: _propTypes2.default.func,
		axiosConfig: _propTypes2.default.func,
		placeholder: _propTypes2.default.string,
		defaultInputValue: _propTypes2.default.string
